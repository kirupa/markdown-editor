...
586 tests across 42 suites, in the shared package. The table below
...
| Critique highlight | 8 | Which wash a passage is drawn in given what is selected and what the pointer is over, and that the three are an order rather than three colours |
