...
| I-153 | The pointer over the bar is an **arrow**, not the editor's I-beam, which reads as "you are about to type here" over a thing you click. Set on every movement rather than pushed and popped: a push whose pop never arrives — the exit does not fire if the window deactivates under the pointer — leaves the arrow stuck over the document. |
