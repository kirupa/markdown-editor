...
520 tests across 36 suites, in the shared package:
...
| Thirteen hands to be marked up in | Five more bundled handwriting faces and four macOS already has, all measured so they read at one size and filtered so the picker never offers a face this machine cannot draw. Found a default that lived in three places and disagreed in two of them, so the menu ticked a hand the rail was not using. See [I-203 to I-208](#10a-ai-assisted-critique). |
