...
| ID-34 | It is sized and centred by the mark's **round body**, as though the leaves were not there — see `macOS/README.md` P-9 and P-11. The leaves stick out of the body at one corner, so placing by the artwork's bounding box would lean every platform the same way at once. |
