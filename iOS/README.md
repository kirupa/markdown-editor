...
| ID-34 | It is placed by measuring the mark's **circular outline**, not its bounding box — see `macOS/README.md` P-9. The leaves stick out of the circle at one corner with nothing to balance them, so centring on the box leans the icon up and to the left on every platform at once. |
