...
// The app icon, which on this platform is the favicon: one file for the tab,
// the landing screen and a home-screen bookmark. Generated by
// `macOS/Scripts/make-icons.swift` from the same artwork and the same
// measurements as the Mac and iOS icons, so the three cannot drift apart.
//
// Resolved against the page rather than this module, which is what `index.php`
// does for the same file — `app/` is served from a content-hashed directory
// and the icon is not.
const MARK = '<img src="icon.svg" class="me-welcome__mark" alt="">';
...
export class WelcomeScreen {
  ...
  buildSide() {
    ...
    side.append(title, actions, this.buildStorage(), footer);
    return side;
  }
